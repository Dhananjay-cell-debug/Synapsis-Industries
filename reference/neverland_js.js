import { L as A, F as k, B as L, a as T } from "./Index.0ed7abc0.js";
import "./vendor.c29bf371.js";
import "./Default.9640cacb.js";
import "./plugin-vue_export-helper.21dcd24c.js";
import "./index.16905068.js";
const w = new WeakMap;
class U extends A {
    constructor(e) {
        super(e);
    ...
    decodeGeometry(e, s) {
        ...
        const n = this.workerNextTaskID++
            , t = e.byteLength
            , o = this._getWorker(n, t).then(a => (r = a,
                new Promise((h, d) => {
                    r._callbacks[n] = {
                        resolve: h,
                        reject: d
    ...
    _initDecoder() {
        ...
        const e = typeof WebAssembly != "object" || this.decoderConfig.type === "js"
            , s = [];
        return e ? s.push(this._loadLibrary("draco_decoder.js", "text")) : (s.push(this._loadLibrary("draco_wasm_wrapper.js", "text")),
            s.push(this._loadLibrary("draco_decoder.wasm", "arraybuffer"))),
            this.decoderPending = Promise.all(s).then(i => {
                const r = i[0];
                e || (this.decoderConfig.wasmBinary = i[1]);
                const n = D.toString()
                    , t = ["/* draco decoder */", r, "", "/* worker */", n.substring(n.indexOf("{") + 1, n.lastIndexOf("}"))].join(`\n`);
    ...
    _releaseTask(e, s) {
        e._taskLoad -= e._taskCosts[s],
            delete e._callbacks[s],
            delete e._taskCosts[s]
    }
    debug() {
...
function D() {
        ...
        switch (o.type) {
            ...
            case "decode":
                ...
                e.then(d => {
                    const u = d.draco
                        , c = new u.Decoder
                        , y = new u.DecoderBuffer;
                    y.Init(new Int8Array(a), a.byteLength);
                    try {
                        const l = s(u, c, y, h)
                            , f = l.attributes.map(m => m.array.buffer);
                        l.index && f.push(l.index.array.buffer),
                            self.postMessage({
                                type: "decode",
                                id: o.id,
                                geometry: l
    ...
    function s(t, o, a, h) {
        ...
        if (l === t.TRIANGULAR_MESH)
            c = new t.Mesh,
                y = o.DecodeBufferToMesh(a, c);
        else if (l === t.POINT_CLOUD)
            c = new t.PointCloud,
                y = o.DecodeBufferToPointCloud(a, c);
        else
        ...
        for (const m in d) {
            ...
            if (h.useUniqueIDs)
                _ = d[m],
                    b = o.GetAttributeByUniqueId(c, _);
            else {
                if (_ = o.GetAttributeId(c, t[d[m]]),
                    _ === -1)
                    continue;
                b = o.GetAttribute(c, _)
            }
            f.attributes.push(r(t, o, c, m, p, b))
        }
        return l === t.TRIANGULAR_MESH && (f.index = i(t, o, c)),
            t.destroy(c),
            f
    }
    function i(t, o, a) {
        const d = a.num_faces() * 3
            , u = d * 4
            , c = t._malloc(u);
    ...
    function r(t, o, a, h, d, u) {
        const c = u.num_components()
            , l = a.num_points() * c
            , f = l * d.BYTES_PER_ELEMENT
            , m = n(t, d)
            , p = t._malloc(f);
        o.GetAttributeDataArrayForAllPoints(a, u, m, f, p);
        const b = new d(t.HEAPF32.buffer, p, l).slice();
        return t._free(p),
        {
            name: h,
            array: b,
